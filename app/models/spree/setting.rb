module Spree
  class Setting
    ...
    FLAGS_LIST_NEW = {0 => {1 => 'Spain.png', 2 => 'es'}, 1 => {1 => 'Portugal.png', 2 => 'pt-PT'}, 2 => {1 => 'Germany.png', 2 => 'de'}, 3 => {1 => 'Austria.png', 2 => 'at'},
     4 => {1 => 'Belgium.png', 2 => 'nl-BE'}, 5 => {1 => 'Nederland.png', 2 => 'nl-NL'}, 6 => {1 => 'Luxembourg.png', 2 => 'lu'},
    7 => {1 => 'Denmark.png', 2 => 'dk'}, 8 => {1 => 'Switzerland.png', 2 => 'ch'}, 9 => {1 => 'Liechtenstein.png', 2 => 'li'}, 10 => {1 => 'CzechRepublic.png', 2 => 'cz'},
    11=> {1 => 'France.png', 2 => 'fr'}, 12 => {1 => 'Monaco.png', 2 => 'mc'}, 13 => {1 => 'UnitedKingdom.png', 2 => 'en-GB'}, 14 => {1 => 'Italy.png', 2 => 'it'},
